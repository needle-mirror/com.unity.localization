...
namespace UnityEditor.Localization.Plugins.Google
{
    ...
    class SheetsServiceProviderEditor : UnityEditor.Editor
    {
        class Styles
        {
            public static readonly GUIContent apiKey = EditorContent.TextContent("API Key");
            public static readonly GUIContent authorize = EditorContent.TextContent("Authorize...", "Authorize the user. This is not required however the first time a connection to a Google sheet is required then authorization will be required.");
            public static readonly GUIContent authentication = EditorContent.TextContent("Authentication");
            public static readonly GUIContent cancel = EditorContent.TextContent("Cancel Authentication");
            public static readonly GUIContent clientId = EditorContent.TextContent("Client Id");
            public static readonly GUIContent clientSecret = EditorContent.TextContent("Client Secret");
            public static readonly GUIContent noCredentials = EditorContent.TextContent("No Credentials Selected");
            public static readonly GUIContent loadCredentials = EditorContent.TextContent("Load Credentials...", "Load the credentials from a json file");
        }
