...
namespace UnityEditor.Localization
{
    ...
    public abstract class LocalizedTableCollection : ScriptableObject, ISerializationCallbackReceiver
    {
        ...
        [SerializeField]
        List<LazyLoadReference<LocalizedTable>> m_Tables = new List<LazyLoadReference<LocalizedTable>>();

        [SerializeReference]
        List<CollectionExtension> m_Extensions = new List<CollectionExtension>();

        ReadOnlyCollection<LazyLoadReference<LocalizedTable>> m_ReadOnlyTables;
        ...
        /// </summary>
        public ReadOnlyCollection<LazyLoadReference<LocalizedTable>> Tables
        {
            get
            {
        ...
        public virtual void AddTable(LocalizedTable table, bool postEvent = true)
        {
            ...
            AddTableToAddressables(table, false);
            m_Tables.Add(new LazyLoadReference<LocalizedTable> { asset = table });
        ...
        public virtual LocalizedTable AddNewTable(LocaleIdentifier localeIdentifier, string path)
        {
            ...
            var table = CreateInstance(TableType) as LocalizedTable;
        ...
        protected virtual void AddTableToAddressables(LocalizedTable table, bool createUndo)
        {
            ...
            if (tableEntry == null)
            {
                var groupName = DefaultTableGroupName;
