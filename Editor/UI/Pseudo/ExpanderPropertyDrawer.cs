...
namespace UnityEditor.Localization.UI
{
    ...
    class ExpanderPropertyDrawer : PropertyDrawerExtended<ExpanderPropertyDrawerData>
    {
        ...
        class Styles
        {
            ...
            public static readonly GUIContent expansionAmount = EditorContent.TextContent("Expansion", "The amount to increase the string size. For example 0.3 would add 30% onto the length.");
            public static readonly GUIContent removeItem = new GUIContent("-");
            public static readonly GUIContent stringLength = EditorContent.TextContent("String Length", "The length the string should fall within for this rule to be applied.");
        }
