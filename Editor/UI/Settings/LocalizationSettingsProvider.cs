...
namespace UnityEditor.Localization.UI
{
    class LocalizationSettingsProvider : AssetSettingsProvider
    {
        class Texts
        {
            public GUIContent noSettingsMsg = EditorContent.TextContent("You have no active Localization Settings. Would you like to create one?");
            public GUIContent activeSettings = EditorContent.TextContent("Active Settings", "The Localization Settings that will be used by this project and included into any builds.");
        }
